 ...
 * @Last Modified time: 2019-11-01 13:37:35
 */
    ...
    $('.add').on('click',function(){
        ...
        if(val.length == 0){
            ...
            paramsSelect.update({
                ...
                data: [{"title":val[0].title,"htImgId":val[0].htImgId}]
            });
    ...
    $('.edit').on('click',function(){
        ...
        if(val[0].parentId){
            paramsSelect.update({
                ...
                data: [{"title":val[0].parentTitle,"htImgId":val[0].parentId}]
            });
        ...
        tree.render({
            ...
            ,click: function(obj){
                ...
                paramsSelect.update({
                    ...
                    data: [{"title":obj.data.title,"htImgId":obj.data.htImgId}]
                });
