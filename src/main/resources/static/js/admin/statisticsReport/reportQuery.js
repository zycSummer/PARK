 ...
 * @Last Modified time: 2019-11-11 15:37:35
 */
    ...
    function renderReprotHeader(ls){
        ...
        $.each(timeArr,function (ii,vv) {
            ...
            $.each(arr,function (i2,v2) {
                ...
                if(v2.avgValue == 'Y'){
                    len2 += 1;
                    colThree.push({field:'avgValue'+ii+v2.energyParaId,title:'平均值',width:100,align:'center'});
                }
                if(v2.diffValue == 'Y'){
                    len2 += 1;
                    colThree.push({field:'diffValue'+ii+v2.energyParaId,title:'差值',width:100,align:'center'});
                }
                if(v2.maxValue == 'Y'){
                    len2 += 1;
                    colThree.push({field:'maxValue'+ii+v2.energyParaId,title:'最大值',width:100,align:'center'});
                }
                if(v2.minValue == 'Y'){
                    len2 += 1;
                    colThree.push({field:'minValue'+ii+v2.energyParaId,title:'最小值',width:100,align:'center'});
                }
                if(v2.timeValue == 'Y'){
                    len2 += 1;
                    colThree.push({field:'timeValue'+ii+v2.energyParaId,title:'时刻值',width:100,align:'center'});
                }
                len1 += len2;
                if(len2 != 1){
