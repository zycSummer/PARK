 ...
 * @Last Modified time: 2019-12-19 13:26:41
 */
layui.use(['form', 'element', 'layer', 'table', 'jquery', 'laypage', 'colorpicker'], function () {
  ...
  $('#del_btn').click(function () {
    ...
    layer.open({
      ...
      area: ['320px', '240px'],
      //宽高
      content: '<div id="park_select_tree"> <form class="layui-form" style="margin:30px;">' + '   <div class="layui-form-item "><label>能耗强度等级标识：</label>' + '<div class="layui-inline">' + tableSelect[0].energyGradeId + '</div></div>' + '   <div class="layui-form-item " style="color:red;">确定要删除此能耗强度等级吗？</div>' + '</form></div>',
      success: function success() {},
      yes: function yes(index) {
        load();
        request.service({
  ...
  $("#energyGradeIdTip").on("click", function () {
    layer.tips('字母、数字、下划线组合，长度不超过20。', '#energyGradeIdTip');
  });
