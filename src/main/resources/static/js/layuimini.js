layui.define(["element", "jquery"], function (exports) {
    var element = layui.element,
     ...
     layuimini = new function () {
        ...
        this.initHome = function (data) {
            ...
            $('#layuiminiHomeTabId').html('<i class="' + data.icon + '"></i> <span>' + data.title + '</span> <i data-tab-close="" class="layui-icon layui-unselect layui-tab-close">ဆ</i>');
            $('#layuiminiHomeTabId').attr('lay-id', data.href+'?mpi=m-p-i-1');
            ...
            $.each(data, function (key, val) {
                ...
                $.each(menuList, function (index, menu) {
                    ...
                    if (menu.children != null && menu.children != []) {
                        ...
                        var buildChildHtml = function (html, child, menuParameId) {
                            ...
                            $.each(child, function (childIndex, childMenu) {
                                ...
                                if (childMenu.child != undefined && childMenu.child != []) {
                                    ...
                                    html += '<a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"  data-tab-mpi="m-p-i-' + menuParameId + '" data-tab="' + childMenu.href + '" target="_self"><i class="' + childMenu.icon + '"></i><span class="layui-left-nav"> ' + childMenu.title + '</span></a>\n';
                                    menuParameId++;
                        ...
                        if(index ===0){
                            leftMenuHtml += '<a href="javascript:;" class="layui-menu-tips layui-this"  data-type="tabAdd" data-tab-mpi="m-p-i-' + menuParameId + '" data-tab="' + menu.href + '" target="_self"><i class="' + menu.icon + '"></i><span class="layui-left-nav"> ' + menu.title + '</span></a>\n';

                        }
                        else{
                            leftMenuHtml += '<a href="javascript:;" class="layui-menu-tips "  data-type="tabAdd" data-tab-mpi="m-p-i-' + menuParameId + '" data-tab="' + menu.href + '" target="_self"><i class="' + menu.icon + '"></i><span class="layui-left-nav"> ' + menu.title + '</span></a>\n';
    ...
    $('body').on('click', '[data-tab]', function () {
        ...
        if(href == '/admin/complex'){
            $('.clildFrame').css('top',0);
        }else{
            $('.clildFrame').css('top',45);
        }
