(function() {
    ...
    window.hteditor_config.handleEvent = function(editor, type, params) {
        ...
        if (type === 'editorCreated') {
            ...
            editor.request('explore', '/displays', function(data) {console.log(data)});
            // addPoints(editor);
        }
    ...
    function handleEditorCreated(editor) {
        ...
        editor.mainMenu.showOnView(editor.mainToolbar, 4, 20);//显示“ 菜单” 点击后出现的菜单项
        editor.mainMenu.hide();//隐藏菜单项
        // console.log(editor.explorer);
        // editor.leftTopTabView.displays.setItemVisible('open', false);
        editor.assets.list.menu.setItemVisible('locateFile',true);
        //图纸页签中拓扑图上的右键菜单（ 只有有节点的时候， 对节点右键点击会出现
        // editor.displayView.graphView.menu.getItemById('newDisplayView').hide();
        // editor.symbolView.graphView.menu //图标页签中拓扑图上的右键菜单（ 只有有节点的时候， 对节点右键点击会出现）
        // editor.displays.tree.menu/editor.symbols.tree.menu/editor.components.tree.menu/editor.assets.tree.menu //左侧上方文件夹右键菜单
        // editor.displays.list.menu // 左侧下方 graphView 列表右键菜单
        // editor.symbols.list.menu //图标中下方的 palette 列表的右键菜单
        // editor.components.list.menu //组件中下方的 palette 列表的右键菜单
        // editor.assets.list.menu //资源中下方的 palette 列表的右键菜单
        // editor.displayTree //图纸中右下角“ 列表” 中节点右键菜单
        // editor.symbolList //图标中右下角“列表” 中节点右键菜单
        //editor.inspectorPane.displayInspector 等设置属性。
